...
#var_vlr_financiamento = int(input("Informe o valor do financiamento: "))
#var_tc = int(input("Informe o valor da TC: "))
#var_qtd_parcelas = int(input("Informe a quantidade parcelas: "))
#var_tx_juros = float(input("Informe a taxa de juros: ").replace(',', '').replace('%', ''))
#var_comis_agt_financi = int(input("Informe a Comissão Agente no financiamento: "))
#var_comis_agt_recebiment = int(input("Informe a Comissão Agente no recebimento: "))
#var_comis_loja_financi = int(input("Informe a Comissão Lojista no financiamento: "))
#var_comis_loja_recebiment = int(input("Informe a Comissão Lojista no recebimento: "))
